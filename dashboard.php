...
?>
								...
								<span class="widget-title1">Reg Users</span>
							</div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
...
?>
                                ...
                                <span class="widget-title2">Total Member</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg3"><i class="fa fa-folder" aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                 <?php 
...
?>
                                ...
                                <span class="widget-title3">Total BP</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
...
?>
                                ...
                                <span class="widget-title4">Total BS</span>
                            </div>
                        </div>
                    </div>
                </div>
